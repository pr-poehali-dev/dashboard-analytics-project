      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid grid-cols-4 w-fit bg-muted/50 p-1">
            <TabsTrigger value="overview" className="data-[state=active]:gradient-purple data-[state=active]:text-white">
              <Icon name="LayoutDashboard" size={16} className="mr-2" />
              Обзор
            </TabsTrigger>
            <TabsTrigger value="metrics" className="data-[state=active]:gradient-purple data-[state=active]:text-white">
            ...
            <TabsTrigger value="sources" className="data-[state=active]:gradient-purple data-[state=active]:text-white">
              ...
              <div className="flex items-end gap-4 h-64">
                {salesData.map((data, index) => (
                  <div key={data.day} className="flex-1 flex flex-col items-center gap-2">
                    <div className="w-full relative" style={{ height: '200px' }}>
                      <div 
                        className="w-full gradient-blue rounded-t-lg absolute bottom-0 hover:opacity-80 transition-opacity cursor-pointer animate-slide-in-right"
                        style={{ 
                          height: `${(data.value / maxValue) * 100}%`,
                          animationDelay: `${index * 50}ms`
                        }}
                      >
                        <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-sm font-semibold bg-blue-500/20 px-2 py-1 rounded">
                          {data.value}
                        </div>
                      </div>
                    </div>
